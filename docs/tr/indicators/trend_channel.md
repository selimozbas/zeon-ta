...
`LRCSLOPE` bar başına düşen sürüklenmedir: pozitifse yükseliş, negatifse düşüş trendi; büyüklüğü ise trendin dikliğidir. `LRCU`'ya yakın fiyat trende göre gerilmiştir; `LRCL`'ye yakın fiyat ise trendin gerisinde kalmıştır.
